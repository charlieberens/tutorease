...
class Profile extends Component {
    ...
    render() {
        if (this.state.loading) {
            ...
            return <div className="profile">{this.state.err}</div>;
            ...
            return (
                <div className="profile-cont">
                    <div className="profile-inner">
                        <Link
                            to="/app/setup"
                            className="edit-profile-icon-outer"
                        >
                            ...
                            <p className="linkify">
                                <Linkify>
                                    {this.state.user.bio ? (
                                        ...
                                        <>
                                            <em>
                                                {this.state.user.displayName} is
                                                bioless. This is truly
                                                unfortunate
                                            </em>{" "}
                                            🙁
                                        </>
                ...
                <div className="profile-cont">
                    <div className="profile-inner">
                        ...
                        {this.state.user.student &&
                            this.state.currentUserTutor && (
                                <div className="profile-bottom">
                                    {this.state.user.pendingStudent ? (
                                        <em>
                                            {this.state.user.displayName} hasn't
                                        ...
                                        <div>
                                            ...
                                            <Link
                                                className="grey-a"
                                                to={`/profile/${this.state.user.username}/performance`}
                                            >
                                                View progress
                                            </Link>
                                        </div>
