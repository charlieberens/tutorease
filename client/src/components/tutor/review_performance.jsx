...
class ReviewPerformance extends Component {
    ...
    componentDidMount = () => {
        this.loadStudentAnswers().then(this.setState({ loading: false }));
    };
    ...
    loadStudentAnswers = async () => {
        ...
        try {
            const res = await axios.get(
                `/api/tutors/set_answers/${this.props.match.params.set_id}/${this.props.match.params.student_username}`
            );
            this.setState({
                ...
                <div className="tutor-rev-question-cont">
                    {this.state.questions.map((question, index) => (
                        <div className="tutor-rev-question">
                            <span className="tutor-rev-question-index">
                                {index + 1}.
                            </span>
                            ...
                            <ul className="tutor-rev-answer-block">
                                {question.responses.map((response, index) => (
                                    ...
                                    >
                                        <div className="tutor-rev-answer-text">
