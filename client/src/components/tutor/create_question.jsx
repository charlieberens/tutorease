...
class CreateQuestion extends Component {
    ...
    componentDidMount = () => {
        window.onbeforeunload = (e) => {
            if (
                ...
                (this.state.body ||
                    this.state.answers.filter((a) => a !== "").length)
            ) {
                const dialogText =
                    "Are you sure you want to leave? Your question will not be saved.";
    ...
    onChange = (e) => {
        if (e.target.name.includes("create-question-answer")) {
            //If input is an answer
    ...
    onSubmit = (e) => {
        ...
        axios
            .post(`/api/tutors/questions/${this.props.set_id}/`, {
                ...
                <div className="create-question-flex">
                    <div className="create-question-left">
                        ...
                        <div className="create-question-left-section">
                            <h4 className="create-question-body-header">
                                Question Body
                                <Link
                                    to="/LaTeX"
                                    className="latex-tooltip unbold"
                                >
                                    <span>?</span>
                                </Link>
                            </h4>
                            ...
                            {this.state.mcq && (
                                <div>
                                    ...
                                    <div className="create-question-answer-outer">
                                        <input
                                            type="text"
                                            name="create-question-answer-0"
                                            className="create-question-answer first-answer"
                                    ...
                                    {this.state.answers
                                        ...
                                        .map((answer, index) => (
                                            <div
                                                key={index}
                                                className="create-question-answer-outer"
                                            >
                                                <input
                                                    type="text"
                                                    name={
                                                    ...
                                                    answerindex={index + 1}
                                                    className="create-question-answer"
                                                    onChange={this.onChange}
                                                    autocomplete="off"
                                                />
                                                <a
                                                    className="remove-answers close"
                                                    name="remove-answers"
                                                    answerindex={index + 1}
                                                    onClick={() =>
                                                        this.onAnswerChange(
                    ...
                    <div className="create-question-preview create-question-right">
                        ...
                        {this.state.answers
                            ...
                            .map((answer, index) => (
                                <div className="create-question-answer-preview">
                                    <Latex>{this.state.answers[index]}</Latex>
                                </div>
                            ))}
                    </div>
                </div>
