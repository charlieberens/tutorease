        ...
        if (index != null) {
            try {
                ...
                const res = await axios.get(
                    `/api/students/check/${this.props.set_id}/${this.props.question_index}`,
        ...
        if (!this.props.review) {
            return (
                <div className="question">
                        ...
                        {this.props.question?.answers.map((answer, index) => (
                            <li
                                ...
                                className={`answer ${
                                    ...
                                    this.state.incorrectAnswers.includes(index)
                                        ? "incorrect"
                                        : ""
                                }`}
                                onClick={
                            ...
                            >
                                <div className="answer-letter-outer">
                                    <span className="answer-letter-inner">
                                        {alphabet[index]}
                                    </span>
                                </div>
                    ...
                    >
                        {this.state.correct ? "Next" : "Submit"}
                    </button>
                </div>
            );
        } else {
