...
class ConfirmAcceptTutor extends Component {
    ...
    onSubmit = () => {
        axios.post(`/api/students/invite/accept/${this.props.tutor._id}`).then(res => {
    ...
    render() {
        return (
            <div>
                <p>Add <em>{this.props.tutor.displayName} (@{this.props.tutor.username})</em> as a tutor?<br/></p>
                <div className="close-cancel-cont">
                    <button className="button-a" onClick={this.onSubmit}>Add</button>
